    ...
    try {
        ...
        for (const doc of snapshot.docs) {
            ...
            posts.push({
                ...
                is_liked: data.likedBy && data.likedBy.includes(userId) ? '1' : '0',
                is_blocked: data.blockedBy && data.blockedBy.includes(userId) ? '1' : '0',
                can_comment: data.canComment ? '1' : '0',
                can_edit: data.userId === userId ? '1' : '0',
